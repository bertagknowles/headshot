                ...
                children: [
                              ...
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (_model.internetEnabled == true) {
                                      setState(() {
                                        _model.isDataUploading1 = false;
                                        _model.uploadedLocalFile1 =
                                            FFUploadedFile(
                                    ...
                                    _shouldSetState = true;
                                    FFAppState().tokRe =
                                        _model.resampleOutput!.results01;
                                    if (_shouldSetState) setState(() {});
                                  },
                                  child: Container(
                                    width:
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    _model.internetEnabledphoto2 =
                                        await actions.checkInternetConnection();
                                    _shouldSetState = true;
                                    if (_model.internetEnabledphoto2 == true) {
                                      FFAppState().imageString2 = '';
                                      if (FFAppState().imageString == null ||
                                          FFAppState().imageString == '') {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
                                            ...
                                            child: Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: AutoSizeText(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ud5i66ne' /* Add Target Headshot Template */,
                                                  ),
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                  ...
                  Expanded(
                    child: FFButtonWidget(
                      ...
                      text: FFLocalizations.of(context).getText(
                        'voc0oo10' /* Or add custom headshot as targ... */,
                      ),
                      options: FFButtonOptions(
                        ...
                        color: FlutterFlowTheme.of(context).umber,
                        textStyle:
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: AutoSizeText(
                        FFLocalizations.of(context).getText(
                          'g6qxjodl' /* AI processing is compute inten... */,
                        ),
                        textAlign: TextAlign.center,
                        style:
                                              ...
                                              content: Text(
                                                valueOrDefault<String>(
                                                  FFLocalizations.of(context)
                                                      .getVariableText(
                                                    enText:
                                                        'Processing error. Try another image with clear face. Cannot process NSFW content.',
                                                    deText:
                                                        'Verarbeitungsfehler. Versuchen Sie ein anderes Bild mit klarem Gesicht. NSFW-Inhalt kann nicht verarbeitet werden.',
                                                    esText:
                                                        'Error de procesamiento. Prueba con otra imagen con la cara despejada. No se puede procesar contenido NSFW.',
                                                    nlText:
                                                        'Verwerkingsfout. Probeer een andere afbeelding met een duidelijk gezicht. Kan NSFW-inhoud niet verwerken.',
                                                    frText:
                                                        'Erreur de traitement. Essayez une autre image avec un visage clair. Impossible de traiter le contenu NSFW.',
                                                    itText:
                                                        'Errore di elaborazione. Provare un\'altra immagine con un volto chiaro. Impossibile elaborare contenuti NSFW.',
                                                    ptText:
                                                        'Erro de processamento. Tente outra imagem com o rosto limpo. Não é possível processar conteúdo NSFW.',
                                                    ruText:
                                                        'Ошибка обработки. Попробуйте другое изображение с чистым лицом. Невозможно обработать NSFW-контент.',
                                                    plText:
                                                        'Błąd przetwarzania. Wypróbuj inny obraz z wyraźną twarzą. Nie można przetworzyć treści NSFW.',
                                                  ),
                                                  'Processing error. Try another image with clear face. Cannot process NSFW content.',
                                                ),
                                                style: FlutterFlowTheme.of(

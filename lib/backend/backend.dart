...
import 'schema/imghash_record.dart';
...
export 'schema/imghash_record.dart';
...
/// Functions to query ImghashRecords (as a Stream and as a Future).
Future<int> queryImghashRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ImghashRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ImghashRecord>> queryImghashRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ImghashRecord.collection,
      ImghashRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ImghashRecord>> queryImghashRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
